          ...
          <div className="text-white space-y-8">
            ...
            <div className="space-y-4 pt-4 animate-slideup" style={{ animationDelay: '0.8s' }}>
              ...
              <button
                ...
                className="w-full lg:w-auto group relative px-8 py-4 bg-gradient-to-r from-blue-500 to-gray-600 text-white font-bold rounded-full text-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center justify-center gap-3"
              >
                <Play size={24} />
                Mulai Belajar
